...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['ID']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['lname']) && isset($_POST['fname'])){
  ...
  $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,fname,lname,appdate,apptime,disease,prescription) values ('$doctor','$pid','$ID','$fname','$lname','$appdate','$apptime','$disease','$prescription')");
    if($query)
    {
...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      ...
      <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> E-HEALTHCARE SYSTEM</a>

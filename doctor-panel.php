...
if(isset($_GET['cancel']))
  {
   ...
   if(isset($_GET['prescribe']))
   {
     ...
     $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,appdate,apptime,disease,prescription) values ('$doctor',$pid,$ID,'$appdate','$apptime','$disease','$prescription');");
     if($query)
     {
